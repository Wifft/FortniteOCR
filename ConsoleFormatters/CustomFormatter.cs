...
namespace FortniteOCR.ConsoleFormatters
{
    internal sealed class CustomFormatter : ConsoleFormatter, IDisposable
    {
        ...
        public CustomFormatter(IOptionsMonitor<CustomOptions> options) : base("wifftFormater") => 
        ...
        internal sealed class CustomOptions : SimpleConsoleFormatterOptions
        {
